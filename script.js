...
function init() {
    ...
    for (let i=0; i< intersects.length;i++){
      ...
      //intersects [0].object.parent.material.color.set("#3d3d3d")  

      intersects[0].object.parent.position.x=(Math.random()-0.5) *500
      intersects[0].object.parent.position.y=(Math.random()-0.5) *500
      intersects[0].object.parent.position.z=(Math.random()-0.5) *500
    }
